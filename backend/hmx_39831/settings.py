"""
Django settings for hmx_39831 project.
...
WSGI_APPLICATION = 'hmx_39831.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hmx_39831 API",
    "DESCRIPTION": "API documentation for hmx_39831 App",
    "VERSION": "v1",
}
